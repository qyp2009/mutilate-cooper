...
env.Append(CPPPATH = ['/usr/local/include', '/opt/local/include','/home/quyupeng/benchmark/memcached/libevent-2.0.21-stable/inst/include'])
env.Append(LIBPATH = ['/opt/local/lib','/home/quyupeng/benchmark/memcached/libevent-2.0.21-stable/inst/lib'])
env.Append(CCFLAGS = '-std=c++0x -D_GNU_SOURCE') # -D__STDC_FORMAT_MACROS')

#env['CXX'] = '/home/yaozhicheng/benchmark/memcached/gcc/gcc-4.8.3/inst/bin/g++'
#env['CC'] = '/home/yaozhicheng/benchmark/memcached/gcc/gcc-4.8.3/inst/bin/gcc'
...
#cooper
#env.Append(CFLAGS = ' -g -Wall -pg')
#env.Append(CPPFLAGS = ' -g -Wall -pg')
